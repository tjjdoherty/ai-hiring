...
My core argument is that **any downward pressure on headcount from AI should apply equally to both domestic and foreign labor at a given company**. The H-1B dataset happens to be a readily available, high quality, company-specific labor report where to my knowledge a domestic equivalent doesn't exist. If the role will ultimately be tested that US citizens could do the job, **is it being tested that AI could do the job?**
...
Unless a group is directly involved in the cutting edge of AI research or other technology (a very small subset), the H-1B visa data can provide evidence that headcount is actually dropping as expected. All else being equal, that is what we might expect. This also ignores any growth in Global Capacity Centres (GCCs), which already generate about $64bn in revenue and is expected to hit $110bn by 2030.

### An H-1B worker's US journey

1. A non-US applies for a US based job requiring a degree and specialized skills.
2. If the candidate is successful, the employer must register the successful candidate for the H-1B lottery. This selects around 85,000 applicants (including 20,000 specifically with a Master's or PhD) [out of over 300,000 annually, sometimes 400,000+](https://www.uscis.gov/working-in-the-united-states/temporary-workers/h-1b-specialty-occupations/h-1b-electronic-registration-process). Employers *don't* have to do labor market testing for US candidates at this stage, but the job must be a specialised, degree-level occupation. 
3. If the candidate is chosen from the lottery, the H-1B is valid for three years, renewable for up to six. The worker's immigrant status in the US is tied to their job and their employer.
4. After six years maximum on an H-1B visa, the job is subject to PERM - it must be labor market tested by advertising to US citizens to demonstrate that there are no qualified US candidates. This takes around 12-18 months with specific obligations of advertising in certain media.
5. If PERM approved, the foreign worker can apply for permanent residence (a Green Card) via employer sponsorship. **Employment-based Green Cards have a per-country cap** (a maximum 7% of 140,000 annual GCs issued). This creates huge backlogs for applicants from countries with a large population; [some sources](https://www.boundless.com/immigration-resources/average-green-card-wait-times) show Green Card applicants from India being processed in 2025 initially applied for in early 2013.
6. Once approved, the worker has permanent residence. This whole process can easily take north of 10 or 15 years with status in the country tied to a specific employer and job.
